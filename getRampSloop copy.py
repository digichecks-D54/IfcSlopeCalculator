...
""" print(distance3d(sortedz_vert[0],sortedz_vert[1]))
print(distance3d(sortedz_vert[0],sortedz_vert[2]))
print(distance3d(sortedz_vert[0],sortedz_vert[3])) """

""" print('rampwidth: '+ str(round(rampwidth,3)))
print('horizontal length: '+str(round(horizontal,3)))
print('rampheight: '+ str(round(rampheight,3)))
print('rampsloop: '+ str(round(rampheight/horizontal,3))) """
